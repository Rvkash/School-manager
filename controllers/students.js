...
// req.query = id=? req.body = corpo req.params = /:id/members show create post
// edit  put
exports.show = function (req, res) {
    ...
    const foundStudent = data
        .students
        .find(
            function (student) { // encontrando Student do data  achou o array de students passar o Student no momento.
                return student.id == id // find retorna true ou false
            }
        )

    if (!foundStudent) 
        return res.send('Student not found') // se não encontrar o Student
...
exports.post = function (req, res) {
    ...
    // Stringify: transforma value em json Callback function
...
exports.put = function (req, res) {
    ...
    const foundStudent = data
        .students
        .find(function (student, foundIndex) {
            if (id == student.id) {
                index = foundIndex
